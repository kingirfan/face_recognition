  ...
  void _confirmDelete(BuildContext context, int id) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            child: const Text('Cancel',style: TextStyle(color: Color(0xFF1f4037))),
            onPressed: () => Navigator.pop(context),
          ),
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: Color(0xFF1f4037),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () => _confirmDelete(context, face[DatabaseHelper.columnId]),
                        child: Container(
                          decoration: const BoxDecoration(
